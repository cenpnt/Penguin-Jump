...
class Game:
    def __init__(self): #initialize game window and other things for the game.
        ...
        original_img = pygame.image.load('Penguin.png').convert_alpha()
        desired_width = 50  # Set your desired width
        desired_height = 50
        self.img_pikachu.image = pygame.transform.scale(original_img, (desired_width, desired_height))
    ...
    def startScreen(self):
        ...
        self.messageToScreen("Press any key to continue...", 25, white, display_width / 2, display_height / 2 + 50)
    ...
    def gameOverScreen(self):
        ...
        self.messageToScreen("Press any key to play again...", 30, white, display_width / 2, display_height / 2 + 50)
